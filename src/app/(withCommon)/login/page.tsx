        ...
        <div className="text-center text-black">
          ...
          <div className="border-b-2 pb-4 mb-6">
            ...
            <div className="flex justify-center gap-4">
              <button onClick={() => setDemoUser({ email: 'testUser@gmail.com', password: '12345En$' })} className="bg-gray-300 hover:bg-gray-200 p-3 rounded-md text-black font-medium text-sm shadow-md">Login As User 👤</button>
              <button onClick={() => setDemoUser({ email: 'testAdmin@gmail.com', password: '12345En$' })} className="bg-gray-300 hover:bg-gray-200 p-3 rounded-md text-black font-medium text-sm shadow-md">Login As Admin 🛠️</button>
            </div>
          </div>
